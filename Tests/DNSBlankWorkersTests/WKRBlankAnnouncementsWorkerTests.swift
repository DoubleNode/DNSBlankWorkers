//
//  WKRBlankAnnouncementsWorkerTests.swift
...
final class WKRBlankAnnouncementsWorkerTests: XCTestCase {
    private var sut: WKRBlankAnnouncements!

    override func setUp() {
        super.setUp()
        sut = WKRBlankAnnouncements()
    }
