//
//  WKRBlankActivityTypesWorkerTests.swift
...
final class WKRBlankActivityTypesWorkerTests: XCTestCase {
    private var sut: WKRBlankActivityTypes!

    override func setUp() {
        super.setUp()
        sut = WKRBlankActivityTypes()
    }
