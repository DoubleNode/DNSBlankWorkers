...
open class WKRBlankCardsWorker: WKRBlankBaseWorker, WKRPTCLCards {
    ...
    public func intDoAdd(_ card: DAOCard,
                         to user: DAOUser,
                         with progress: DNSPTCLProgressBlock?,
    ...
    public func intDoLoadCard(for id: String,
                              with progress: DNSPTCLProgressBlock?,
                              and block: WKRPTCLCardsBlkCard?,
                              then resultBlock: DNSPTCLResultBlock?) throws {
        _ = resultBlock?(.unhandled)
    }
    public func intDoLoadCard(for transaction: DAOTransaction,
                              with progress: DNSPTCLProgressBlock?,
                              and block: WKRPTCLCardsBlkCard?,
                              then resultBlock: DNSPTCLResultBlock?) throws {
        _ = resultBlock?(.unhandled)
    }
    public func intDoLoadCards(for user: DAOUser,
                               with progress: DNSPTCLProgressBlock?,
                               and block: WKRPTCLCardsBlkACard?,
                               then resultBlock: DNSPTCLResultBlock?) throws {
        _ = resultBlock?(.unhandled)
    }
    public func intDoLoadTransactions(for card: DAOCard,
                                      with progress: DNSPTCLProgressBlock?,
                                      and block: WKRPTCLCardsBlkATransaction?,
                                      then resultBlock: DNSPTCLResultBlock?) throws {
        _ = resultBlock?(.unhandled)
    }
    public func intDoRemove(_ card: DAOCard,
                            from user: DAOUser,
                            with progress: DNSPTCLProgressBlock?,
                            and block: WKRPTCLCardsBlkBool?,
                            then resultBlock: DNSPTCLResultBlock?) throws {
    ...
    public func intDoUpdate(_ card: DAOCard,
                            with progress: DNSPTCLProgressBlock?,
                            and block: WKRPTCLCardsBlkBool?,
                            then resultBlock: DNSPTCLResultBlock?) throws {
        _ = resultBlock?(.unhandled)
