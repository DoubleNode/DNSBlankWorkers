...
open class WKRBlankAdmin: WKRBlankBase, WKRPTCLAdmin {
    ...
    public func doLoadDeletedAccounts(thatAre status: DNSPTCLDeletedStatus,
                                      with progress: DNSPTCLProgressBlock?,
                                      and block: WKRPTCLAdminBlkAAccount?) {
        self.runDo(runNext: {
            return self.nextWorker?.doLoadDeletedAccounts(thatAre: status, with: progress, and: block)
        },
        doWork: {
            return self.intDoLoadDeletedAccounts(thatAre: status, with: progress, and: block, then: $0)
        })
    }
    ...
    public func doLoadDeletedAccounts(thatAre status: DNSPTCLDeletedStatus,
        ...
        self.doLoadDeletedAccounts(thatAre: status, with: nil, and: block)
    }
    public func doLoadDeletedStatus(with block: WKRPTCLAdminBlkAAccount?) {
    ...
    open func intDoLoadDeletedAccounts(thatAre status: DNSPTCLDeletedStatus,
                                       with progress: DNSPTCLProgressBlock?,
                                       and block: WKRPTCLAdminBlkAAccount?,
