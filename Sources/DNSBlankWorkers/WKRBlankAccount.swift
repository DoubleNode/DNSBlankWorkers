...
open class WKRBlankAccount: WKRBlankBase, WKRPTCLAccount {
    ...
    public func doApprove(linkRequests: DAOAccountLinkRequest,
                          with progress: DNSPTCLProgressBlock?,
                          and block: WKRPTCLAccountBlkVoid?) {
        self.runDo(runNext: {
            return self.nextWorker?.doApprove(linkRequests: linkRequests, with: progress, and: block)
        },
        doWork: {
            return self.intDoApprove(linkRequests: linkRequests, with: progress, and: block, then: $0)
        })
    }
    ...
    public func doDecline(linkRequests: DAOAccountLinkRequest,
                          with progress: DNSPTCLProgressBlock?,
                          and block: WKRPTCLAccountBlkVoid?) {
        self.runDo(runNext: {
            return self.nextWorker?.doDecline(linkRequests: linkRequests, with: progress, and: block)
        },
        doWork: {
            return self.intDoDecline(linkRequests: linkRequests, with: progress, and: block, then: $0)
        })
    }
    ...
    public func doApprove(linkRequests: DAOAccountLinkRequest,
        ...
        self.doApprove(linkRequests: linkRequests, with: nil, and: block)
    }
    public func doDeactivate(account: DAOAccount,
                             and block: WKRPTCLAccountBlkVoid?) {
    ...
    public func doDecline(linkRequests: DAOAccountLinkRequest,
                          with block: WKRPTCLAccountBlkVoid?) {
        self.doDecline(linkRequests: linkRequests, with: nil, and: block)
    }
    public func doDelete(account: DAOAccount,
                         and block: WKRPTCLAccountBlkVoid?) {
    ...
    open func intDoApprove(linkRequests: DAOAccountLinkRequest,
                           with progress: DNSPTCLProgressBlock?,
                           and block: WKRPTCLAccountBlkVoid?,
                           then resultBlock: DNSPTCLResultBlock?) {
        _ = resultBlock?(.unhandled)
    ...
    open func intDoDecline(linkRequests: DAOAccountLinkRequest,
                           with progress: DNSPTCLProgressBlock?,
                           and block: WKRPTCLAccountBlkVoid?,
                           then resultBlock: DNSPTCLResultBlock?) {
        _ = resultBlock?(.unhandled)
