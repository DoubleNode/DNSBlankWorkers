...
open class WKRBaseBeacons: WKRBaseWorker, WKRPTCLBeacons {
    ...
    open func intDoStopRangeBeacons(for processKey: String,
        ...
        return resultBlock?(.unhandled) as! WKRPTCLBeaconsResVoid // swiftlint:disable:this force_cast
    }
}
